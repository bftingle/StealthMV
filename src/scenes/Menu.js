class Menu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('grader_button', './assets/grader_button.png');
    ...
    create() {
        ...
        new Button(this, 680, 530, 'grader_button', 0, '', '20px', 'gotoDevPlay').setOrigin(0.5, 0.5).setInteractive({useHandCursor: true});
